        ...
        <div id="content" class="clearfix">
            ...
            if (is_author()) : ?>
                ...
                <div class="author-bio clearfix">
                    ...
                    <h2 class="author-name"><?php _e('About ', 'themify'); ?>
                        <span><?php echo $curauth->display_name; ?></span></h2>
                    <?php if ($author_url != ''): ?><p class="author-url"><a
                            href="<?php echo $author_url; ?>"><?php echo $author_url; ?></a>
                        </p><?php endif; //author url ?>
