...
function themify_editor_menu()
{
    ...
    <head>
        ...
        <script src="<?php echo includes_url('/js/jquery/jquery.js'); ?>" language="javascript"
                type="text/javascript"></script>
        <script src="<?php echo includes_url('/js/tinymce/tiny_mce_popup.js'); ?>" language="javascript"
                type="text/javascript"></script>
        <script src="<?php echo includes_url('/js/tinymce/utils/form_utils.js'); ?>" language="javascript"
                type="text/javascript"></script>
            ...
            function themifyRepaint(sc_content) {
                if (window.tinyMCE) {
                    if (typeof window.tinyMCE.execInstanceCommand !== 'undefined') {
                        ...
                        if (editor_id == 'tfb_lb_hidden_editor') {
                            editor_id = 'content';
                        }
        ...
        <script src="<?php echo esc_url(THEMIFY_URI . '/js/themify.font-icons-select.js'); ?>"
                type="text/javascript"></script>
        <base target="_self"/>
    </head>
    <body id="wp-admin" onload="tinyMCEPopup.executeOnLoad('init();');document.body.style.display='';"
          style="display: none">
    ...
    <form name="shortcode-options" id='shortcode-options' action="#">
        <div class="panel current" style="margin-bottom: 0;">
            ...
            foreach ($fields as $field) { ?>
                ...
                <label for="<?php echo esc_attr($field['id']); ?>"><span
                    class="label-inner"><?php echo esc_html($field['label']); ?></span>
            <?php } ?>
                <?php
                if ('text' == $field['type']) {
                    ?>
        ...
        <div class="mceActionPanel submitbox" style="border-top: 1px solid #CCC;padding-top: 5px;">
            <div id="delete-action" style="float: left;">
                <a class="submitdelete deletion" onclick="<?php echo esc_js('tinyMCEPopup.close();'); ?>"
                   style="text-decoration: underline;cursor:pointer;padding: 0 2px;"><?php _e('Cancel', 'themify'); ?></a>
            </div>

            <div id="wp-link-update" style="float: right;">
                <input class="button button-primary button-large" type="submit" id="wp-link-submit" name="insert"
                       value="<?php _e('Insert', 'themify'); ?>"
                       onclick="<?php echo esc_js('themify_insert_shortcode(shortcode_type);'); ?>"/>
            </div>
        </div>
