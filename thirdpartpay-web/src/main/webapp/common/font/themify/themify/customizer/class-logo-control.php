...
class Themify_Logo_Control extends Themify_Control
{
    ...
    <?php endif; ?>
        ...
        <div class="themify-customizer-brick mode-switcher logo-modes">
            <label><input type="radio" value="text" class="logo-mode"
                          name="logo_mode" <?php checked($mode, 'text'); ?> /><?php _e('Site Title', 'themify'); ?>
            </label>
            <label><input type="radio" value="image" class="logo-mode"
                          name="logo_mode" <?php checked($mode, 'image'); ?>/><?php _e('Logo Image', 'themify'); ?>
            </label>
            <label><input type="radio" value="none" class="logo-mode"
                          name="logo_mode" <?php checked($mode, 'none'); ?>/><?php _e('None', 'themify'); ?></label>
        </div>

        <!-- Site Logo Text Mode -->
        <div class="logo-mode-wrap logo-text-mode">
            <label><?php _e('Site Title', 'themify'); ?><input type="text" class="site-name"
                                                               value="<?php echo esc_attr(get_bloginfo('name')); ?>"/></label>
        </div>
        ...
        <div class="logo-mode-wrap logo-text-mode logo-image-mode">
            <p><label><?php _e('Custom Site Logo Link', 'themify'); ?><input type="text" class="site-link"
                                                                             value="<?php echo esc_url($link); ?>"/></label>
            </p>
        </div>
