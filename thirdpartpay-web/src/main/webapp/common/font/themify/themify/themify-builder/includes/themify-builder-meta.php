...
<div class="themify_builder themify_builder_admin clearfix">
    ...
    <div class="themify_builder_module_panel clearfix">
        ...
        <?php foreach (Themify_Builder_Model::$modules as $module): ?>
            ...
            <div class="<?php echo esc_attr($class); ?>" data-module-slug="<?php echo esc_attr($module->slug); ?>"
                 data-module-name="<?php echo esc_attr($module->name); ?>">
                <strong class="module_name"><?php echo esc_html($module->name); ?></strong>
                <a href="#" class="add_module"
                   data-module-name="<?php echo esc_attr($module->slug); ?>"><?php _e('Add', 'themify') ?></a>
            </div>
            <!-- /module -->
        <?php endforeach; ?>
    </div>
        ...
        <div id="themify_builder_row_wrapper" class="themify_builder_row_js_wrapper themify_builder_editor_wrapper">
            ...
            <?php if (!empty($builder_data) && is_array($builder_data)): ?>
                ...
                <?php foreach ($builder_data as $rows => $row):
                    ...
                    ?>
                    <div data-gutter="<?php echo esc_attr($row_gutter_class); ?>"
                         class="themify_builder_row clearfix <?php echo esc_attr($row_column_equal_height); ?>"
                        ...
                        <div class="themify_builder_row_top">
                            <div class="row_menu">
                                ...
                                <ul class="themify_builder_dropdown">
                                    <li><a href="#"
                                           class="themify_builder_option_row"><?php _e('Options', 'themify') ?></a></li>
                                    <li><a href="#"
                            ...
                            <?php if (isset($row['cols'])) : ?>
                                <?php foreach ($row['cols'] as $cols => $col): ?>
                                    <div class="themify_builder_col <?php echo esc_attr($col['grid_class']); ?>">
                                        <div
                                            class="themify_builder_column_styling_icon ti-brush themify_builder_option_column"></div>
                                        <div class="themify_module_holder">
                                            <div
                                                class="empty_holder_text"><?php _e('drop module here', 'themify') ?></div>
                                            <!-- /empty module text -->
                                            ...
                                            <?php if (isset($col['modules']) && count($col['modules']) > 0): ?>
                                                <?php foreach ($col['modules'] as $mod): ?>
                                                    ...
                                                    <?php if (isset($mod['mod_name'])): ?>
                                                        <div
                                                            class="themify_builder_module module-<?php echo esc_attr($mod['mod_name']); ?> active_module"
                                                            data-mod-name="<?php echo esc_attr($mod['mod_name']); ?>">
                                                            <div class="module_menu">
                                                                <div class="menu_icon">
                                                                </div>
                                                                <ul class="themify_builder_dropdown">
                                                                    <li><a href="#" class="themify_module_options"
                                                                           data-module-name="<?php echo esc_attr($mod['mod_name']); ?>"><?php _e('Edit', 'themify') ?></a>
                                                                    </li>
                                                                    <li><a href="#"
                                                                           class="themify_module_duplicate"><?php _e('Duplicate', 'themify') ?></a>
                                                                    </li>
                                                                    <li><a href="#"
                                                                           class="themify_module_delete"><?php _e('Delete', 'themify') ?></a>
                                                                    </li>
                                                                </ul>
                                                            </div>
                                                            <div class="module_label">
                                                                <strong
                                                                    class="module_name"><?php echo Themify_Builder_Model::get_module_name($mod['mod_name']); ?></strong>
                                                            ...
                                                            <div class="themify_module_settings">
                                                                <script
                                                                    type="text/json"><?php echo json_encode($mod['mod_settings']); ?></script>
                                                            </div>
                                                        </div>
                                                        <!-- /active_module -->
                                                    <?php elseif (isset($mod['cols']) && count($mod['cols']) > 0):
                                                        ...
                                                        ?>
                                                        <div data-gutter="<?php echo esc_attr($sub_row_gutter); ?>"
                                                             class="themify_builder_sub_row clearfix <?php echo esc_attr($sub_row_column_equal_height); ?>"
                                                            ...
                                                            <div class="themify_builder_sub_row_top">
                                                                ...
                                                                <ul class="sub_row_action">
                                                                    <li><a href="#" class="sub_row_duplicate"><span
                                                                                class="ti-layers"></span></a></li>
                                                                    <li><a href="#" class="sub_row_delete"><span
                                                                                class="ti-close"></span></a></li>
                                                                </ul>
                                                            </div>
                                                            <!-- /row_top -->
                                                            <div class="themify_builder_sub_row_content">
                                                                <?php foreach ($mod['cols'] as $sub_row => $sub_col): ?>
                                                                    <div
                                                                        class="themify_builder_col <?php echo esc_attr($sub_col['grid_class']); ?>">
                                                                        <div
                                                                            class="themify_builder_column_styling_icon ti-brush themify_builder_option_column"></div>
                                                                        <div class="themify_module_holder">
                                                                            <div
                                                                            ...
                                                                            <?php if (isset($sub_col['modules']) && count($sub_col['modules']) > 0):
                                                                                foreach ($sub_col['modules'] as $sub_module): ?>
                                                                                    <div
                                                                                        class="themify_builder_module module-<?php echo esc_attr($sub_module['mod_name']); ?> active_module"
                                                                                        data-mod-name="<?php echo esc_attr($sub_module['mod_name']); ?>">
                                                                                        <div class="module_menu">
                                                                                            <div class="menu_icon">
                                                                                            </div>
                                                                                            <ul class="themify_builder_dropdown">
                                                                                                <li><a href="#"
                                                                                                       class="themify_module_options"
                                                                                                       data-module-name="<?php echo esc_attr($sub_module['mod_name']); ?>"><?php _e('Edit', 'themify') ?></a>
                                                                                                </li>
                                                                                                <li><a href="#"
                                                                                                       class="themify_module_duplicate"><?php _e('Duplicate', 'themify') ?></a>
                                                                                                </li>
                                                                                        ...
                                                                                        <div class="module_label">
                                                                                            <strong
                                                                                                class="module_name"><?php echo Themify_Builder_Model::get_module_name($sub_module['mod_name']); ?></strong>
                                                                                        ...
                                                                                        <div
                                                                                            class="themify_module_settings">
                                                                                            <script
                                                                                                type="text/json"><?php echo json_encode($sub_module['mod_settings']); ?></script>
                                                                                        </div>
                                                                                    </div>
                                                                                    <!-- /active_module -->
                                                                        ...
                                                                        <div class="column-data-styling"
                                                                             data-styling="<?php echo esc_attr($sub_column_data_styling); ?>"></div>
                                                                    </div>
                                                                <?php endforeach; ?>
                                                            </div>
                                                            <!-- /sub_row_content -->
                                        ...
                                        <div class="column-data-styling"
                                             data-styling="<?php echo esc_attr($column_data_styling); ?>"></div>
                                        <!-- /module_holder -->
                                    </div>
                                    <!-- /builder_col -->
                ...
                <div class="themify_builder_row clearfix">
                    ...
                    <div class="themify_builder_row_top">
                        <div class="row_menu">
                            ...
                            <ul class="themify_builder_dropdown">
                                <li><a href="#" class="themify_builder_option_row"><?php _e('Options', 'themify') ?></a>
                                </li>
                                <li><a href="#"
                                       class="themify_builder_duplicate_row"><?php _e('Duplicate', 'themify') ?></a>
                                </li>
                                <li><a href="#" class="themify_builder_delete_row"><?php _e('Delete', 'themify') ?></a>
                                </li>
                            </ul>
                        </div>
                        <!-- /row_menu -->
            ...
            <div class="themify_builder_save">
                <ul class="themify_builder_backend_options_menu left">
                    <li>
                        ...
                        <ul>
                            <li><a href="#"
                                   id="themify_builder_duplicate"><?php _e('Duplicate this page', 'themify') ?></a></li>
                            <li class="has-children">
                                <a href="#"><?php esc_html_e('Import From', 'themify'); ?></a>
                                <ul>
                                    <li><a href="#"
                                           class="themify_builder_import_page"><?php esc_html_e('Existing Pages', 'themify'); ?></a>
                                    </li>
                                    <li><a href="#"
                                           class="themify_builder_import_post"><?php esc_html_e('Existing Posts', 'themify'); ?></a>
                                    </li>
                                </ul>
                            </li>
                            <li class="has-children">
                                ...
                                <ul>
                                    <li><a href="#"
                                           class="themify_builder_import_file"><?php esc_html_e('Import', 'themify'); ?></a>
                                    </li>
                                    <li>
                                        <a href="<?php echo wp_nonce_url('?themify_builder_export_file=true&postid=' . $post->ID, 'themify_builder_export_nonce') ?>"><?php esc_html_e('Export', 'themify'); ?></a>
                                    </li>
                                </ul>
                            </li>
                            <li class="has-children">
                                ...
                                <ul>
                                    <li><a href="#"
                                           class="themify_builder_load_layout"><?php esc_html_e('Load Layout', 'themify'); ?></a>
                                    </li>
                                    <li><a href="#"
                                           class="themify_builder_save_layout"><?php esc_html_e('Save as Layout', 'themify'); ?></a>
                                    </li>
                                </ul>
                            </li>
                        </ul>
                    ...
                    <li>
                                            <span class="themify_builder_undo_tools">
                                                    <a class="themify-builder-undo-btn js-themify-builder-undo-btn"
                                                       rel="themify-tooltip-top"
                                                       data-title="<?php esc_html_e('Undo', 'themify'); ?>"><i
                                                            class="ti-back-left"></i></a>
                                                    <a class="themify-builder-redo-btn js-themify-builder-redo-btn"
                                                       rel="themify-tooltip-top"
                                                       data-title="<?php esc_html_e('Redo', 'themify'); ?>"><i
                                                            class="ti-back-right"></i></a>
                                            </span>
                    </li>
                </ul>
                <?php if (isset($pagenow) && $pagenow !== 'post-new.php'): ?>
                    <a href="#" id="themify_builder_switch_frontend"
                       class="themify_builder_switch_frontend"><?php _e('Switch to frontend', 'themify') ?></a>
