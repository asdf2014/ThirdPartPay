    ...
    <?php endif; ?>
        ...
        <div class="themify-customizer-brick">
            ...
            <div class="auto-prop-combo js-hide hcollapse">
                ...
                ?>
                <input type="text" class="dimension-width" value="<?php echo esc_attr($value); ?>"
			...
			<span class="auto-prop-label">
				<label for="<?php echo esc_attr($id); ?>"
                       class="dimension-row-label"><?php echo esc_html($dimension_label); ?></label>
                ...
                <input id="<?php echo esc_attr($auto_id); ?>" type="checkbox"
                       class="auto-prop" <?php checked($auto, 'auto'); ?> value="auto" data-hide="js-hide"/>
