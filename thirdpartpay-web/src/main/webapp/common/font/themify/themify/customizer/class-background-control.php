    ...
    <?php endif; ?>
        ...
        <div class="themify-customizer-brick">
            ...
            <div class="custom-select background-position">
                <select class="position-style">
                    <?php foreach ($positions as $position => $label) : ?>
                        <option
                            value="<?php echo esc_attr($position); ?>" <?php selected($current_position, $position); ?>><?php echo esc_html($label); ?></option>
                    <?php endforeach; ?>
                </select>
            </div>
            ...
            <div class="no-image">
                ...
                <input id="<?php echo esc_attr($noimage_id); ?>" type="checkbox"
                       class="disable-control" <?php checked($noimage, 'noimage'); ?> value="noimage"/>
