                ...
                <?php foreach ($roles as $role => $slug) {
                    ...
                    <li class="role-access-controller">
                        ...
                        <div class="role-option role-default">
                            <input type="radio" id="default-<?php echo esc_attr($prefix . $role); ?>"
                                   name="<?php echo esc_attr($prefix . $role); ?>"
                                   value="default" <?php echo checked($value, 'default', false); ?>/>
                            <label
                                for="default-<?php echo esc_attr($prefix . $role); ?>"><?php _e('Default', 'themify'); ?></label>
                        </div>

                        <!-- Set option to enable -->
                        <div class="role-option role-enable">
                            <input type="radio" id="enable-<?php echo esc_attr($prefix . $role); ?>"
                                   name="<?php echo esc_attr($prefix . $role); ?>"
                                   value="enable" <?php echo checked($value, 'enable', false); ?>/>
                            <label
                                for="enable-<?php echo esc_attr($prefix . $role); ?>"><?php _e('Enable', 'themify'); ?></label>
                        </div>

                        <!-- Set option to disable -->
                        <div class="role-option role-disable">
                            <input type="radio" id="disable-<?php echo esc_attr($prefix . $role); ?>"
                                   name="<?php echo esc_attr($prefix . $role); ?>"
                                   value="disable" <?php echo checked($value, 'disable', false); ?>/>
                            <label
                                for="disable-<?php echo esc_attr($prefix . $role); ?>"><?php _e('Disable', 'themify'); ?></label>
                        </div>
                    </li>
                <?php }//end foreach 
                ?>
