    ...
    <?php endif; ?>
            ...
            <div class="custom-select">
                <select class="position">
                    ...
                    <?php foreach ($positions as $position => $label) : ?>
                        <option
                            value="<?php echo esc_attr($position); ?>" <?php selected($position, $current_position); ?>><?php echo esc_html($label); ?></option>
                    <?php endforeach; ?>
                </select>
            </div>
            <label><?php _e('Position', 'themify'); ?></label><a
                href="http://themify.me/docs/styling#properties-positioning" target="_blank" class="doc-link">(?)</a>
        ...
        <div class="themify-customizer-brick position-wrap">
            ...
            <div class="auto-prop-combo js-hide-<?php echo esc_attr($side); ?> hcollapse">
                ...
                <input type="text" class="dimension-width" value="<?php echo esc_attr($width); ?>"
                ...
                <div class="custom-select">
                    <select class="dimension-unit" data-side="<?php echo esc_attr($side); ?>">
                        <?php foreach ($units as $unit) :
                            ...
                            <option
                                value="<?php echo esc_attr($unit); ?>" <?php selected($unit_val, $unit); ?>><?php echo esc_html($unit); ?></option>
                        <?php endforeach; ?>
                    </select>
                </div>
			...
			<span class="auto-prop-label">
				...
				<input id="<?php echo esc_attr($auto_id); ?>" type="checkbox"
                       ...
                       data-hide="js-hide-<?php echo esc_attr($side); ?>" data-side="<?php echo esc_attr($side); ?>"/>
