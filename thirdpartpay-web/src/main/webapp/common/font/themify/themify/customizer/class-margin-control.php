        ...
        foreach ($sides as $side => $side_label) : ?>
            <div class="themify-customizer-brick <?php if ($first) : echo 'useforall';
                ...
                <div class="auto-prop-combo js-hide-<?php echo esc_attr($side); ?> hcollapse">
                    ...
                    <input type="text" class="dimension-width <?php echo esc_attr($dimension_type); ?>-width"
                           data-side="<?php echo esc_attr($side); ?>" value="<?php echo esc_attr($width); ?>"
                    ...
                    <div class="custom-select">
                        <select class="dimension-unit <?php echo esc_attr($dimension_type); ?>-unit"
                            ...
                            <?php foreach ($units as $unit) : ?>
                                <option
                                    value="<?php echo esc_attr($unit); ?>" <?php selected($unit, $current_unit); ?>><?php echo esc_html($unit); ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                    ...
                    <?php if ('padding' == $dimension_type) : ?>
                        <label for="<?php echo esc_attr($id); ?>"
                               class="dimension-row-label <?php if ($first) : echo 'same-label'; endif; ?>" <?php if ($first) : echo 'data-same="' . esc_attr($property) . '" data-notsame="' . esc_attr($side_label) . '"'; endif; ?>><?php echo esc_html($side_label); ?></label>
                    <?php endif; ?>
					...
					<span class="auto-prop-label">
                        ...
                        <label for="<?php echo esc_attr($id); ?>"
                               class="dimension-row-label <?php if ($first) : echo 'same-label'; endif; ?>" <?php if ($first) : echo 'data-same="' . esc_attr($property) . '" data-notsame="' . esc_attr($side_label) . '"'; endif; ?>><?php echo esc_html($side_label); ?></label>
						<input id="<?php echo esc_attr($auto_id); ?>" type="checkbox"
                               class="auto-prop" <?php checked($auto, 'auto'); ?> value="auto"
                               data-hide="js-hide-<?php echo esc_attr($side); ?>"
                               data-side="<?php echo esc_attr($side); ?>"/>
