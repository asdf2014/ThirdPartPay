<div class="themify_builder_options_tab_wrapper">
    <div class="themify_builder_options_tab_content">
        <form id="themify_builder_load_template_form" method="POST">
                ...
                <div id="themify_builder_options_styling">
                    <div class="themify_builder_tabs">
                        <ul class="themify_builder_tab clearfix">
                            <li class="title"><a
                                    href="#themify_builder_tabs_pre-designed"><?php _e('Pre-designed', 'themify'); ?></a>
                            </li>
                            <li class="title"><a
                                    href="#themify_builder_tabs_custom"><?php _e('Custom', 'themify'); ?></a></li>
                        </ul>
                                    ...
                                    if (1 == $layout['prebuilt']):
                                        ...
                                        <li class="layout_preview_list">
                                            <div class="layout_preview"
                                                 data-layout-slug="<?php echo esc_attr($layout['slug']); ?>"
                                                 data-builtin="<?php echo $layout['prebuilt'] == true ? 'yes' : 'no' ?>">
            ...
            <a href="<?php echo admin_url('post-new.php?post_type=' . $this->layout->post_type_name); ?>"
               target="_blank"
               class="add_new">
