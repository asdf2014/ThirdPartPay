    ...
    <div class="themify_builder_sub_row clearfix gutter-default">
        ...
        <div class="themify_builder_sub_row_content">
            <div class="themify_builder_col {{ data.newclass }}">
                <div class="themify_builder_column_styling_icon ti-brush themify_builder_option_column"
                     title="<?php esc_attr_e('Column Styling', 'themify'); ?>"></div>
...
<script type="text/html" id="tmpl-builder_module_item">
    <div class="themify_builder_module {{ data.slug }} active_module" data-mod-name="{{ data.slug }}">
        ...
        <div class="themify_module_settings">
            <script type="text/json"></script></div>
</div>
</script>
...
id = "tmpl-builder_row" >
    < div
class
= "themify_builder_row module_row clearfix gutter-default" >
    < div
class
= "row_inner_wrapper" >
    < div
...
= "row_action" >
    < li > < a
href = "#"
data - title = "<?php _e('Export', 'themify') ?>"
class
= "themify_builder_export_component"
data - component = "row"
rel = "themify-tooltip-bottom" >
    < span
class
= "ti-export" > < / span >
    ...
    < li > < a
href = "#"
data - title = "<?php _e('Import', 'themify') ?>"
class
= "themify_builder_import_component"
data - component = "row"
rel = "themify-tooltip-bottom" >
    < span
class
...
= "separator" > < / li >
    < li > < a
href = "#"
data - title = "<?php _e('Copy', 'themify') ?>"
class
= "themify_builder_copy_component"
data - component = "row"
rel = "themify-tooltip-bottom" >
    < span
class
= "ti-files" > < / span >
    ...
    < li > < a
href = "#"
data - title = "<?php _e('Paste', 'themify') ?>"
class
= "themify_builder_paste_component"
data - component = "row"
rel = "themify-tooltip-bottom" >
    < span
class
...
= "separator" > < / li >
    < li > < a
href = "#"
data - title = "<?php _e('Options', 'themify') ?>"
class
= "themify_builder_option_row"
rel = "themify-tooltip-bottom" >
    < span
class
= "ti-pencil" > < / span >
...
= "separator" > < / li >
    < li > < a
href = "#"
data - title = "<?php _e('Toggle Row', 'themify') ?>"
class
= "themify_builder_toggle_row" >
    < span
class
= "ti-angle-up" > < / span >
    < / a > < / li >
...
= "themify_builder_row_content" >
    ...
    < div
class
= "themify_builder_col col-full first last" >
    < div
class
= "themify_builder_column_styling_icon ti-brush themify_builder_option_column"
title = "<?php esc_attr_e('Column Styling', 'themify'); ?>" > < / div >
    < div
class
= "themify_module_holder" >
    < div
class
= "empty_holder_text" ><?php _e('drop module here', 'themify') ?>< / div >
    < / div >
    < div
class
= "column-data-styling"
