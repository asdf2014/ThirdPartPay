    ...
    <div class="themify_builder_tabs" id="themify_builder_tabs_<?php echo esc_attr($id); ?>">
        <ul class="clearfix">
            <?php foreach ($field['tabs'] as $key => $tab) : ?>
                <li><a href="#tf_<?php echo esc_attr($id . '_' . $key); ?>"> <?php echo esc_html($tab['label']); ?> </a>
                </li>
            <?php endforeach; ?>
        </ul>
...
function themify_builder_module_settings_field_builder($field)
{
    ...
    if ($option['type'] == 'multi') : ?>
        <div
            class="themify_builder_field <?php echo isset($option['wrap_with_class']) ? esc_attr($option['wrap_with_class']) : ''; ?>">

            <?php if (isset($option['label']) && $option['label'] != false): ?>
                <div
                    class="themify_builder_label"><?php echo esc_html($option['label']); ?></div><!-- /themify_builder_input_title -->
            <?php endif; ?>

            <div
                class="<?php echo esc_attr($option['id']) . ' tf_multi_fields tf_fields_count_' . esc_attr(count($option['options'])) ?>">
        ...
        <div class="themify_builder_input"<?php echo ('wp_editor' == $option['type']) ? ' style="width:100%;"' : ''; ?>>
            <?php if ($option['type'] == 'text'): ?>
                ...
                <?php if (isset($option['colorpicker']) && $option['colorpicker'] == true) : ?>
                    ...
                    <input type="text"
                           class="<?php echo isset($option['class']) ? esc_attr($option['class']) : ''; ?> colordisplay" <?php echo themify_builder_get_binding_data($option); ?> />
                    <input id="<?php echo esc_attr($option['id']); ?>" name="<?php echo esc_attr($option['id']); ?>"
                           value="<?php if (isset($option['value'])) echo esc_attr($option['value']); ?>"
                           class="builderColorSelectInput tfb_lb_option_child" type="hidden"
                           data-input-id="<?php echo esc_attr($option['id']); ?>"/>
                <?php else : ?>
                    <input name="<?php echo esc_attr($option['id']); ?>"
                           class="<?php echo isset($option['class']) ? esc_attr($option['class']) : ''; ?> tfb_lb_option_child <?php echo isset($add_class) ? esc_attr($add_class) : ''; ?>"
                           type="text" data-input-id="<?php echo esc_attr($option['id']); ?>"/>
                    <?php if (isset($option['iconpicker']) && $option['iconpicker'] == true) : ?>
                        <a class="button button-secondary hide-if-no-js themify_fa_toggle"
                           href="#"><?php _e('Insert Icon', 'themify'); ?></a>
                    <?php endif; ?>
                    <?php if (isset($option['after'])) : echo wp_kses_post($option['after']); endif; ?>
                <?php endif; ?>

            <?php elseif ('image' == $option['type']): ?>
                <input data-input-id="<?php echo esc_attr($option['id']); ?>"
                       name="<?php echo esc_attr($option['id']); ?>"
                       placeholder="<?php if (isset($option['value'])) echo esc_attr($option['value']); ?>"
                       class="<?php echo esc_attr($option['class']); ?> themify-builder-uploader-input tfb_lb_option_child"
                       type="text"/><br/>
                ...
                <div class="small">
                    ...
                    <?php else: ?>
                        <div class="themify-builder-plupload-upload-uic hide-if-no-js tf-upload-btn"
                             id="<?php echo esc_attr($option['id']); ?>themify-builder-plupload-upload-ui">
                            <input id="<?php echo esc_attr($option['id']); ?>themify-builder-plupload-browse-button"
                                   type="button" value="<?php esc_attr_e(__('Upload', 'themify')); ?>"
                                   class="builder_button"/>
                            <span class="ajaxnonceplu"
                                  id="ajaxnonceplu<?php echo wp_create_nonce($option['id'] . 'themify-builder-plupload'); ?>"></span>
                        </div> <?php _e('or', 'themify'); ?> <a href="#"
                                                                class="themify-builder-media-uploader tf-upload-btn"
                                                                data-uploader-title="<?php esc_attr_e('Upload an Image', 'themify') ?>"
                                                                data-uploader-button-text="<?php esc_attr_e('Insert file URL', 'themify') ?>"><?php _e('Browse Library', 'themify') ?></a>
            ...
            <?php elseif ('audio' == $option['type']): ?>
                ...
                <div class="small">
                    ...
                    <?php else: ?>
                        <div class="themify-builder-plupload-upload-uic hide-if-no-js tf-upload-btn"
                             id="<?php echo esc_attr($option['id']); ?>themify-builder-plupload-upload-ui"
                             data-extensions="<?php echo esc_attr(implode(',', wp_get_audio_extensions())); ?>">
                            <input id="<?php echo esc_attr($option['id']); ?>themify-builder-plupload-browse-button"
                                   type="button" value="<?php esc_attr_e(__('Upload', 'themify')); ?>"
                                   class="builder_button"/>
                            <span class="ajaxnonceplu"
                                  id="ajaxnonceplu<?php echo wp_create_nonce($option['id'] . 'themify-builder-plupload'); ?>"></span>
                                                                ...
                                                                class="themify-builder-media-uploader tf-upload-btn"
                                                                data-uploader-title="<?php esc_attr_e('Upload an Image', 'themify') ?>"
                                                                data-uploader-button-text="<?php esc_attr_e('Insert file URL', 'themify') ?>"
                                                                data-library-type="audio"><?php _e('Browse Library', 'themify') ?></a>
            ...
            <?php elseif ($option['type'] == 'textarea'): ?>
                <textarea name="<?php echo esc_attr($option['id']); ?>"
                          class="<?php echo esc_attr($option['class']); ?> tfb_lb_option_child" <?php echo (isset($option['rows'])) ? 'rows="' . esc_attr($option['rows']) . '"' : ''; ?>
                          data-input-id="<?php echo esc_attr($option['id']); ?>"></textarea><br/>

                <?php if (isset($option['radio'])): ?>
                    <div data-input-id="<?php echo esc_attr($option['radio']['id']); ?>"
                         class="tfb_lb_option_child tf-radio-choice">
                        <?php echo esc_html($option['radio']['label']); ?>
                        <?php foreach ($option['radio']['options'] as $k => $v): ?>
                            <input id="<?php echo esc_attr($option['radio']['id'] . '_' . $k); ?>" type="radio"
                                   name="<?php echo esc_attr($option['radio']['id']); ?>"
                                   class="themify-builder-radio-dnd" value="<?php echo esc_attr($k); ?>"/>
                            <label for="<?php echo esc_attr($option['radio']['id'] . '_' . $k); ?>"
                                   class="pad-right themify-builder-radio-dnd-label"><?php echo wp_kses_post($k); ?></label>
                        <?php endforeach; ?>
                    </div>
                <?php endif; // endif radio input ?>

            <?php elseif ($option['type'] == 'select') : ?>
                <select data-input-id="<?php echo esc_attr($option['id']); ?>"
                        name="<?php echo esc_attr($option['id']); ?>" class="tfb_lb_option_child">
                    <?php if (isset($option['empty'])): ?>
                        <option
                            value="<?php echo esc_attr($option['empty']['val']); ?>"><?php echo esc_html($option['empty']['label']); ?></option>
                    <?php endif; ?>
            ...
            <?php elseif ('layout' == $option['type']): ?>
                <p id="<?php echo esc_attr($option['id']); ?>"
                   class="layout_icon tfb_lb_option_child themify-layout-icon">
                    <?php foreach ($option['options'] as $option): ?>
                        <a href="#" id="<?php echo esc_attr($option['value']); ?>"
                           title="<?php echo esc_attr($option['label']); ?>" class="tfl-icon">
            ...
            <?php elseif ('checkbox' == $option['type']): ?>
                ...
                <div id="<?php echo esc_attr($option['id']); ?>" class="tfb_lb_option_child themify-checkbox">
                    <?php foreach ($option['options'] as $opt): ?>
                        ...
                        ?>
                        <label class="pad-right"><input id="<?php echo esc_attr($option['id'] . '_' . $opt['name']); ?>"
                                                        name="<?php echo esc_attr($option['id']); ?>[]" type="checkbox"
                                                        class="<?php echo isset($option['class']) ? $option['class'] : '' ?> tf-checkbox"
                                                        value="<?php echo esc_attr($opt['name']); ?>" <?php echo $checkbox_checked; ?> /><?php echo wp_kses_post($opt['value']); ?>
                        </label>
            ...
            <?php elseif ('radio' == $option['type']): ?>
                <div data-input-id="<?php echo esc_attr($option['id']); ?>" class="tfb_lb_option_child tf-radio-choice">
                    <?php foreach ($option['options'] as $k => $v): ?>
                        ...
                        <input id="<?php echo esc_attr($option['id'] . '_' . $k); ?>" type="radio"
                               name="<?php echo esc_attr($option['id']); ?>" class="themify-builder-radio-dnd"
                               value="<?php echo esc_attr($k); ?>"/>
                        <label for="<?php echo esc_attr($option['id'] . '_' . $k); ?>"
                               class="pad-right themify-builder-radio-dnd-label"><?php echo wp_kses_post($v); ?></label>
                    <?php endforeach; ?>
                </div>
            ...
            <?php elseif ('video' == $option['type']): ?>
                ...
                <div class="small">
                    ...
                    <?php else: ?>
                        <div class="themify-builder-plupload-upload-uic hide-if-no-js tf-upload-btn"
                             id="<?php echo esc_attr($option['id']) ?>themify-builder-plupload-upload-ui"
                             data-extensions="<?php echo esc_attr(implode(',', wp_get_video_extensions())) ?>">
                            <input id="<?php echo esc_attr($option['id']) ?>themify-builder-plupload-browse-button"
                                   type="button" value="<?php esc_attr_e(__('Upload', 'themify')) ?>"
                                   class="builder_button"/>
                            <span class="ajaxnonceplu"
                                  id="ajaxnonceplu<?php echo wp_create_nonce($option['id'] . 'themify-builder-plupload') ?>"></span>
                                                               ...
                                                               class="themify-builder-media-uploader tf-upload-btn"
                                                               data-uploader-title="<?php _e('Upload a Video', 'themify') ?>"
                                                               data-uploader-button-text="<?php esc_attr_e('Insert file URL', 'themify') ?>"
                                                               data-library-type="video"><?php _e('Browse Library', 'themify') ?></a>
                    <?php endif; ?>
                </div>
    ...
    function themify_builder_module_settings_field($module_options, $module_name)
    {
        ...
        <?php endif; ?>
            ...
            if ($field['type'] == 'multi') {
                ...
                ?>
                <div
                    class="<?php echo (isset($field['wrap_with_class'])) ? esc_attr($field['wrap_with_class']) : ''; ?>">
                    <hr/>
                            ...
                            <div class="themify_builder_row_top">
                                <div class="row_menu">
                                    ...
                                    <ul style="display: none;" class="themify_builder_dropdown">
                                        <li><a href="#"
                                               class="themify_builder_duplicate_row"><?php _e('Duplicate', 'themify') ?></a>
                                        </li>
                                        <li><a href="#"
                                               class="themify_builder_delete_row"><?php _e('Delete', 'themify') ?></a>
                                        </li>
                                    </ul>
                                </div>
                                <!-- /row_menu -->
                    ...
                    <p class="add_new"><a href="#"><span
                                class="themify_builder_icon add"></span><?php echo isset($field['new_row_text']) ? $field['new_row_text'] : __('Add new row', 'themify'); ?>
                        </a></p>
                </div>
                <!-- /builder wrapper -->
                <?php
                ...
                ?>
                <div
                    class="themify_builder_input<?php echo isset($field['pushed']) && $field['pushed'] != '' ? ' ' . $field['pushed'] : ''; ?>">
                    <?php if ('text' == $field['type']): ?>

                        <?php if (isset($field['colorpicker']) && $field['colorpicker'] == true) : ?>
                            <span class="builderColorSelect"><span></span></span>
                            <input type="text"
                                   class="<?php echo esc_attr($field['class']); ?> colordisplay" <?php echo themify_builder_get_binding_data($field); ?> />
                            <input id="<?php echo esc_attr($field['id']); ?>"
                                   name="<?php echo esc_attr($field['id']); ?>"
                                   value="<?php if (isset($field['value'])) echo esc_attr($field['value']); ?>"
                                   class="builderColorSelectInput tfb_lb_option" type="hidden"/>
                        <?php else : ?>
                            <input id="<?php echo esc_attr($field['id']); ?>"
                                   name="<?php echo esc_attr($field['id']); ?>"
                                   value="<?php if (isset($field['value'])) echo esc_attr($field['value']); ?>"
                                   class="<?php echo isset($field['class']) ? $field['class'] : '' ?> <?php echo isset($add_class) ? esc_attr($add_class) : ''; ?> tfb_lb_option"
                                   type="text" <?php echo themify_builder_get_binding_data($field); ?> />
                            <?php if (isset($field['after'])) : echo wp_kses_post($field['after']); endif; ?>

                            <?php if (isset($field['unit'])): ?>
                                <select id="<?php echo esc_attr($field['unit']['id']); ?>"
                                        class="tfb_lb_option" <?php echo themify_builder_get_binding_data($field); ?>>
                                    <?php foreach ($field['unit']['options'] as $u): ?>
                                        <option
                                            value="<?php echo esc_attr($u['value']); ?>" <?php echo (isset($field['unit']['selected']) && $field['unit']['selected'] == $u['value']) ? 'selected="selected"' : ''; ?>><?php echo esc_html($u['value']); ?></option>
                                    <?php endforeach; ?>
                                </select>
                            <?php endif; // unit ?>
                        <?php endif; ?>
                    ...
                    <?php elseif ('icon' == $field['type']): ?>
                        <input id="<?php echo esc_attr($field['id']); ?>" name="<?php echo esc_attr($field['id']); ?>"
                               value="<?php if (isset($field['value'])) echo esc_attr($field['value']); ?>"
                               class="themify_field_icon <?php if (isset($field['class'])) echo esc_attr($field['class']); ?> tfb_lb_option"
                               type="text" <?php echo themify_builder_get_binding_data($field); ?> />
                        <a class="button button-secondary hide-if-no-js themify_fa_toggle" href="#"
                           data-target="#<?php echo esc_attr($field['id']); ?>"><?php _e('Insert Icon', 'themify'); ?></a>
                    ...
                    <?php elseif ('radio' == $field['type']): ?>
                        ...
                        ?>
                        <div id="<?php echo esc_attr($field['id']); ?>"
                             class="tfb_lb_option tf-radio-input-container <?php echo esc_attr($option_js_wrap); ?>">
                            <?php foreach ($field['options'] as $k => $v): ?>
                                ...
                                ?>
                                <input id="<?php echo esc_attr($field['id'] . '_' . $k); ?>"
                                       name="<?php echo esc_attr($field['id']); ?>" type="radio"
                                       class="<?php echo esc_attr($option_js); ?>"
                                       value="<?php echo esc_attr($k); ?>" <?php echo " $default_checked $data_el"; ?>/>
                                <label for="<?php echo esc_attr($field['id'] . '_' . $k); ?>"
                                       class="pad-right"><?php echo wp_kses_post($v); ?></label>
                    ...
                    <?php elseif ('layout' == $field['type']): ?>
                        <p id="<?php echo esc_attr($field['id']); ?>"
                    ...
                    <?php elseif ('image' == $field['type']): ?>
                        <input id="<?php echo esc_attr($field['id']); ?>" name="<?php echo esc_attr($field['id']); ?>"
                               placeholder="<?php if (isset($field['value'])) echo esc_attr($field['value']); ?>"
                               class="<?php echo esc_attr($field['class']); ?> themify-builder-uploader-input tfb_lb_option"
                               type="text" <?php echo themify_builder_get_binding_data($field); ?> /><br/>
                        ...
                        <div class="small">
                            ...
                            <?php else: ?>
                                <div class="themify-builder-plupload-upload-uic hide-if-no-js tf-upload-btn"
                                     id="<?php echo esc_attr($field['id']); ?>themify-builder-plupload-upload-ui">
                                    <input
                                        id="<?php echo esc_attr($field['id']); ?>themify-builder-plupload-browse-button"
                                        type="button" value="<?php esc_attr_e(__('Upload', 'themify')); ?>"
                                        class="builder_button"/>
                                    <span class="ajaxnonceplu"
                                          id="ajaxnonceplu<?php echo wp_create_nonce($field['id'] . 'themify-builder-plupload'); ?>"></span>
                                </div> <?php _e('or', 'themify') ?> <a href="#"
                                                                       class="themify-builder-media-uploader tf-upload-btn"
                                                                       data-uploader-title="<?php esc_attr_e('Upload an Image', 'themify') ?>"
                                                                       data-uploader-button-text="<?php esc_attr_e('Insert file URL', 'themify') ?>"><?php _e('Browse Library', 'themify') ?></a>
                    ...
                    <?php elseif ('checkbox' == $field['type']): ?>
                        ...
                        <div id="<?php echo esc_attr($field['id']); ?>" class="tfb_lb_option themify-checkbox">
                            <?php foreach ($field['options'] as $opt): ?>
                                ...
                                ?>
                                <input id="<?php echo esc_attr($field['id'] . '_' . $opt['name']); ?>"
                                       name="<?php echo esc_attr($field['id']); ?>[]" type="checkbox"
                                       class="<?php echo isset($opt['class']) ? $opt['class'] : '' ?> tf-checkbox"
                                       value="<?php echo esc_attr($opt['name']); ?>" <?php echo $checkbox_checked; ?> />
                                <label for="<?php echo esc_attr($field['id'] . '_' . $opt['name']); ?>"
                                       class="pad-right"><?php echo wp_kses_post($opt['value']); ?></label>
                    ...
                    <?php elseif ('textarea' == $field['type']): ?>
                        <textarea id="<?php echo esc_attr($field['id']); ?>"
                                  name="<?php echo esc_attr($field['id']); ?>"
                                  class="<?php echo esc_attr($field['class']); ?> tfb_lb_option" <?php if (isset($field['rows'])) echo 'rows="' . $field['rows'] . '"'; ?>
                                  type="text" <?php echo themify_builder_get_binding_data($field); ?>></textarea>
                        ...
                        <?php if (!isset($field['hide']) || $field['hide'] == false): ?>
                            <select id="<?php echo esc_attr($field['id']); ?>"
                                ...
                                <?php if (isset($field['empty'])): ?>
                                    <option
                                        value="<?php echo esc_attr($field['empty']['val']); ?>"><?php echo esc_html($field['empty']['label']); ?></option>
                                <?php endif; ?>
                    ...
                    <?php elseif ('select_menu' == $field['type']): ?>
                        <select id="<?php echo esc_attr($field['id']); ?>" name="<?php echo esc_attr($field['id']); ?>"
                                class="tfb_lb_option select_menu_field" <?php echo themify_builder_get_binding_data($field); ?>>
                    ...
                    <?php elseif ('query_category' == $field['type']): ?>
                        ...
                        ?>
                        <select id="<?php echo esc_attr($field['id'] . '_dropdown'); ?>"
                                class="query_category_single" <?php echo themify_builder_get_binding_data($field); ?>>
                            <option></option>
                        ...
                        <?php _e('or', 'themify') ?>
                        <input class="small query_category_multiple" type="text"/><br/>
                        <small><?php _e('multiple category IDs (eg. 2,5,8) or slug (eg. news,blog,featured) or exclude category IDs(eg. -2,-5,-8)', 'themify'); ?></small>
                        <br/>
                        <input type="hidden" id="<?php echo esc_attr($field['id']); ?>"
                               name="<?php echo esc_attr($field['id']); ?>" value=""
                               class="tfb_lb_option themify-option-query-cat"/>
                    ...
                    elseif ('multifield' == $field['type']): ?>
                        ...
                        <?php if (isset($field['options']['select'])): ?>
                            <select id="<?php echo esc_attr($field['options']['select']['id']); ?>"
                                    class="tfb_lb_option" <?php echo themify_builder_get_binding_data($field); ?>>
                                <?php foreach ($field['options']['select']['options'] as $opt => $label): ?>
                                    <option
                                        value="<?php echo esc_attr($opt); ?>"><?php echo esc_html($label); ?></option>
                                <?php endforeach; ?>
                            </select>
                        <?php endif; ?>

                        <?php if (isset($field['options']['text'])): ?>
                            <input id="<?php echo esc_attr($field['options']['text']['id']); ?>"
                                   class="xsmall tfb_lb_option"
                                   type="text" <?php echo themify_builder_get_binding_data($field); ?> />
                        ...
                        <?php if (isset($field['options']['colorpicker'])): ?>
                            ...
                            <span class="builderColorSelect"><span></span></span>
                            <input id="<?php echo esc_attr($field['options']['colorpicker']['id']); ?>"
                                   class="<?php echo esc_attr($color_class); ?> tfb_lb_option builderColorSelectInput"
                                   type="text"/>
                        <?php endif; ?>
                    ...
                    elseif ('slider' == $field['type']):
                        ...
                        <?php if ($fieldsec['type'] == 'select'): ?>
                            <select id="<?php echo esc_attr($fieldsec['id']); ?>"
                                    name="<?php echo esc_attr($fieldsec['id']); ?>"
                                    class="tfb_lb_option" <?php echo themify_builder_get_binding_data($field); ?>>
                                <?php if (isset($fieldsec['empty'])): ?>
                                    <option
                                        value="<?php echo esc_attr($fieldsec['empty']['val']); ?>"><?php echo esc_html($fieldsec['empty']['label']); ?></option>
                                <?php endif; ?>
                        ...
                        <?php elseif ($fieldsec['type'] == 'text'): ?>
                            <input id="<?php echo esc_attr($fieldsec['id']); ?>"
                                   name="<?php echo esc_attr($fieldsec['id']); ?>"
                                   class="<?php echo esc_attr($fieldsec['class']); ?> tfb_lb_option"
                                   class="<?php echo esc_attr($fieldsec['class']); ?> tfb_lb_option" type="text"/>
...
if (!function_exists('themify_builder_styling_field')) {
    ...
    function themify_builder_styling_field($styling)
    {
        switch ($styling['type']) {
            ...
            case 'text': ?>
                <input id="<?php echo esc_attr($styling['id']); ?>" name="<?php echo esc_attr($styling['id']); ?>"
                       type="text" value="" class="<?php echo esc_attr($styling['class']); ?> tfb_lb_option">
            ...
            case 'textarea': ?>
                <textarea id="<?php echo esc_attr($styling['id']); ?>" name="<?php echo esc_attr($styling['id']); ?>"
                          class="<?php echo esc_attr($styling['class']); ?> tfb_lb_option"><?php if (isset($styling['value'])) : echo esc_textarea($styling['value']); endif; ?></textarea>
                <?php if (isset($styling['description'])) {
                    echo '<small>' . wp_kses_post($styling['description']) . '</small>';
                } ?>
                <?php
            ...
            case 'image': ?>
                <input id="<?php echo esc_attr($styling['id']); ?>" name="<?php echo esc_attr($styling['id']); ?>"
                       placeholder="<?php if (isset($styling['value'])) echo esc_attr($styling['value']); ?>"
                       class="<?php echo esc_attr($styling['class']); ?> themify-builder-uploader-input tfb_lb_option"
                       type="text"/><br/>
                ...
                <div class="small">
                    ...
                    <?php else: ?>
                        <div class="themify-builder-plupload-upload-uic hide-if-no-js tf-upload-btn"
                             id="<?php echo esc_attr($styling['id']); ?>themify-builder-plupload-upload-ui">
                            <input id="<?php echo esc_attr($styling['id']); ?>themify-builder-plupload-browse-button"
                                   type="button" value="<?php esc_attr_e(__('Upload', 'themify')); ?>"
                                   class="builder_button"/>
                            <span class="ajaxnonceplu"
                                  id="ajaxnonceplu<?php echo wp_create_nonce($styling['id'] . 'themify-builder-plupload'); ?>"></span>
                        </div> <?php _e('or', 'themify') ?> <a href="#"
                                                               class="themify-builder-media-uploader tf-upload-btn"
                                                               data-uploader-title="<?php esc_attr_e('Upload an Image', 'themify') ?>"
                                                               data-uploader-button-text="<?php esc_attr_e('Insert file URL', 'themify') ?>"><?php _e('Browse Library', 'themify') ?></a>
            ...
            case 'select': ?>
                ...
                <select id="<?php echo esc_attr($styling['id']); ?>" name="<?php echo esc_attr($styling['id']); ?>"
                        class="tfb_lb_option <?php echo isset($styling['class']) ? esc_attr($styling['class']) : ''; ?>">
                    <?php if (isset($styling['default'])): ?>
                        <option
                            value="<?php echo esc_attr($styling['default']); ?>"><?php echo esc_html($styling['default']); ?></option>
                    <?php endif;

                    foreach ($styling['meta'] as $option): ?>
                        <option
                            value="<?php echo esc_attr($option['value']); ?>"><?php echo esc_html($option['name']); ?></option>
                    <?php endforeach; ?>
            ...
            case 'animation_select': ?>
                ...
                <select id="<?php echo esc_attr($styling['id']); ?>" name="<?php echo esc_attr($styling['id']); ?>"
                        class="tfb_lb_option <?php echo esc_attr($class); ?>">
                    <option value=""></option>
                    ...
                    foreach ($animation as $group): ?>
                        ...
                        <optgroup label="<?php echo esc_attr($group['group_label']); ?>">
                            <?php foreach ($group['options'] as $opt): ?>
                                <option
                                    value="<?php echo esc_attr($opt['value']); ?>"><?php echo esc_html($opt['name']); ?></option>
                            <?php endforeach; ?>
                        </optgroup>
            ...
            case 'font_select':
                ...
                <select id="<?php echo esc_attr($styling['id']); ?>" name="<?php echo esc_attr($styling['id']); ?>"
                        class="tfb_lb_option <?php echo esc_attr($styling['class']); ?>">
                    <?php if (isset($styling['default'])): ?>
                        <option
                            value="<?php echo esc_attr($styling['default']); ?>"><?php echo esc_html($styling['default']); ?></option>
                    <?php endif;
            ...
            case 'checkbox':
                ...
                <div id="<?php echo esc_attr($styling['id']); ?>" class="tfb_lb_option themify-checkbox">
                    <?php foreach ($styling['options'] as $opt): ?>
                        ...
                        ?>
                        <input id="<?php echo esc_attr($styling['id'] . '_' . $opt['name']); ?>"
                               name="<?php echo esc_attr($styling['id']); ?>" type="checkbox"
                               class="<?php echo isset($styling['class']) ? $styling['class'] : '' ?> tfb_lb_option tf-checkbox"
                               value="<?php echo esc_attr($opt['name']); ?>" <?php echo $checkbox_checked; ?> />
                        <label for="<?php echo esc_attr($styling['id'] . '_' . $opt['name']); ?>"
                               class="pad-right"><?php echo wp_kses_post($opt['value']); ?></label>
            ...
            case 'radio':
                ...
                ?>
                <div id="<?php echo esc_attr($styling['id']); ?>"
                     class="tfb_lb_option tf-radio-input-container <?php echo esc_attr($option_js_wrap); ?>">
                    <?php
                    foreach ($styling['meta'] as $option) {
                        ...
                        ?>
                        <input type="radio" id="<?php echo esc_attr($styling['id'] . '_' . $option['value']); ?>"
                               name="<?php echo esc_attr($styling['id']); ?>"
                               value="<?php echo esc_attr($option['value']); ?>"
                               class="tfb_lb_option <?php echo esc_attr($option_js); ?>" <?php echo $checked . ' ' . $data_el; ?>>
                        <label
                            for="<?php echo esc_attr($styling['id'] . '_' . $option['value']); ?>"><?php echo esc_html($option['name']); ?></label>
                        <?php
                    }
                    ?>
                    <?php if (isset($styling['description'])) {
            ...
            case 'builder':
                ?>
                <div id="<?php echo esc_attr($styling['id']); ?>"
                     class="themify_builder_row_opt_builder_wrap themify_builder_row_js_wrapper tfb_lb_option">
                    <div class="themify_builder_row clearfix">
                        <div class="themify_builder_row_top">
                            <div class="row_menu">
                                ...
                                <ul style="display:none" class="themify_builder_dropdown">
                                    ...
                                    <li><a href="#"
                                           class="themify_builder_delete_row"><?php _e('Delete', 'themify') ?></a></li>
                                </ul>
                            </div>
                ...
                <p class="add_new"><a href="#"><span
                            class="themify_builder_icon add"></span><?php echo isset($styling['new_row_text']) ? $styling['new_row_text'] : __('Add new row', 'themify') ?>
                    </a></p>
                <?php
                break;
        }
