...
<article
    id="post-<?php the_id(); ?>" <?php post_class("post clearfix " . $themify->get_categories_as_classes(get_the_id())); ?>>
    ...
    <div class="post-content">
        ...
        <?php if ($themify->hide_date != 'yes'): ?>
            <time datetime="<?php the_time('o-m-d') ?>"
                  class="post-date entry-date updated"><?php echo get_the_date(apply_filters('themify_loop_date', '')) ?></time>
        ...
        <?php if ($themify->hide_title != 'yes'): ?>
            ...
            <?php else: ?>
                <h1 class="post-title entry-title"><a href="<?php echo themify_get_featured_image_link(); ?>"
        ...
        <div class="entry-content">
            ...
            <?php if ('excerpt' == $themify->display_content && !is_attachment()) : ?>
                ...
                <?php if (themify_check('setting-excerpt_more')) : ?>
                    <p><a href="<?php the_permalink(); ?>" title="<?php the_title_attribute('echo=0'); ?>"
